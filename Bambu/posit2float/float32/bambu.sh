...
bambu -v3 -O3 -lm $root_dir/../posit2float.c --top-fname=posit2float_op -I$root_dir \
   --generate-tb=$root_dir/../test.xml --simulator=MODELSIM \
   $root_dir/synth_${period}/converters_lib.xml \
   --C-no-parse=$root_dir/../posit2float_fake.c \
   --evaluation \
   --pretty-print=a.c \
