...
/* Default data type */
#if !defined(DATA_TYPE_IS_INT) && !defined(DATA_TYPE_IS_FLOAT) && !defined(DATA_TYPE_IS_DOUBLE) && !defined(DATA_TYPE_IS_POSIT32) && !defined(DATA_TYPE_IS_POSIT64)
...
#define DATA_TYPE PositEncoding< P_SIZE, WES, hint::VivadoWrapper >
#define DATA_PRINTF_MODIFIER "%0.2lf "
#define SCALAR_VAL(x) DATA_TYPE{{0}}
#define SQRT_FUN(x) sqrt(x)
#define EXP_FUN(x) exp(x)
#define POW_FUN(x, y) pow(x, y)
#endif
