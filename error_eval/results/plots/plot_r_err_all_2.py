...
def add_plot(benchmark_name, ylim_top, ax):
    shift = width/2
    (posit32_error, float_error, posit64_error, double_error, posit_float_error,
    ...
    rect_dbl = ax.bar(x + (0*width+shift), double_error, width,
                      ...
                      edgecolor='k',
                      linewidth=0.5,)
    rect_pos64 = ax.bar(x + (1*width+shift), posit64_error, width,
                        label='Posit64', color=colors[4], 
    ...
    ax.bar_label(rect_flt, rotation=90, fmt='%1.2e',
                 padding=3 if float_error[-1] < ylim_top else -60, 
                 fontsize=9)
    ax.bar_label(rect_pos32, rotation=90, fmt='%1.2e',
                 padding=3 if posit32_error[-1] < ylim_top else -60, 
                 fontsize=9)
    ax.bar_label(rect_dbl, rotation=90, fmt='%1.2e',
                 padding=3 if double_error[-1] < ylim_top else -60, 
                 fontsize=9)
